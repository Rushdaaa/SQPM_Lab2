...
public class Binary {
	...
	/**
	 * Adding two binary variables. For more information, visit <a href=
	 * "https://www.wikihow.com/Add-Binary-Numbers"> Add-Binary-Numbers </a>.
	 *
	...
	/**
	 * Performs bitwise OR between two binary variables.
	 *
	...
	/**
	 * Performs bitwise AND between two binary variables.
	 *
	 * @param num1 The first binary variable
	 * @param num2 The second binary variable
	...
	public static Binary multiply(Binary num1, Binary num2) {
		...
		Binary addend = new Binary(num1.getValue());

		for (int i = num2.number.length() - 1; i >= 0; i--) {
			if (num2.number.charAt(i) == '1') {
				result = Binary.add(result, addend);
			}
			addend = Binary.add(addend, addend); // Shift left by multiplying by 2
		}
		return result;
	}
}